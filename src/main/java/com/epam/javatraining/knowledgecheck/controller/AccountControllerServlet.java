...
import com.epam.javatraining.knowledgecheck.data.dao.StudentDao;
...
import com.epam.javatraining.knowledgecheck.data.dao.jdbc.StudentDaoJdbc;
import com.epam.javatraining.knowledgecheck.data.dao.jdbc.TutorDaoJdbc;
import com.epam.javatraining.knowledgecheck.data.dao.jdbc.UserDaoJdbc;
...
import com.epam.javatraining.knowledgecheck.service.tools.*;
...
public class AccountControllerServlet extends AbstractBaseControllerServlet {
    ...
    private void showUserList(HttpServletRequest request, HttpServletResponse response)
        ...
        List<User> users = userDao.findAll(offset, (long) COUNT_USER_ON_PAGE);
    ...
    private void showProfile(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(data.getRole()) {
            case STUDENT:
                data = (new StudentDaoJdbc()).get(id);
                break;
            case TUTOR:
                data = (new TutorDaoJdbc()).get(id);
                break;
            default:
                pageNotFound(request, response);
                return;
    ...
    private boolean saveUser(User user) throws DAOException {
        switch(user.getRole()) {
            ...
            default:
                UserDaoJdbc userDao = new UserDaoJdbc();
                return userDao.updateUpdate( user );
        }
    }

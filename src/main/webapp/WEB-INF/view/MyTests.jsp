...
<div class="container text-left">
    ...
    <div class="row">
        ...
        <div class="col text-right">
            <a href="${pageContext.request.contextPath}/testboard/add" class="btn btn-info btn-dark" role="button">Add test</a>
        </div>
    </div>
                    ...
                    <div class="card-footer text-muted">
                        <div class="row">
                            ...
                            <div class="col text-right">
                                ...
                                <a href="${pageContext.request.contextPath}/testboard/delete?testId=${test.id}"
                                   class="btn btn-sm btn-dark" role="button"
                                   onclick="return confirm('Are you sure you want to delete the test?')">
                                    Delete test
                                </a>

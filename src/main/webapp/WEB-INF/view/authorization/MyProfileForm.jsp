        ...
        <c:if test="${verifyEmail != null}">
            <div class="col-4">
                <button class="btn btn-dark btn-block m-1" type="submit" name="btnCancel" formnovalidate
                        formaction="${pageContext.request.contextPath}/authorization/myprofile">
                    Cancel
                </button>
            </div>
            <div class="col-4">
                <button class="btn btn-dark btn-block m-1" type="submit" name="btnBack" formnovalidate
                        formaction="${pageContext.request.contextPath}/authorization/myprofile/back">
                    Back
                </button>
            </div>
            <div class="col-4">
                <button class="btn btn-dark btn-block m-1" type="submit" name="btnConfirm"
                        formaction="${pageContext.request.contextPath}/authorization/myprofile/confirm">
                    Confirm
                </button>
            </div>
        </c:if>
        <c:if test="${verifyEmail == null}">
            ...
            <div class="col-6">
                <button class="btn btn-dark btn-block m-1" type="submit" name="btnSave"
                        formaction="${pageContext.request.contextPath}/authorization/myprofile/verify">
                    Save
                </button>
            </div>
            <div class="col-3"></div>
